...
class Help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="`wiki (thing)`", value="Searches Wikipedia. You must use a _ in place of spaces for multi-word searches.", inline=False)
        embed.add_field(name="`cat`", value="Sends a cute cat!", inline=False)
        embed.add_field(name="`dog`", value="Sends a cute dog!", inline=False)
        embed.add_field(name="`meme`", value="Sends a meme from r/memes.", inline=False)
        embed.add_field(name="`surreal`", value="Sends a meme from r/surrealmemes.", inline=False)
        embed.add_field(name="`reddit (subreddit)`", value="Sends a post from any specified subreddit.", inline=False)
